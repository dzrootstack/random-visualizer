...
export default function Simulation() {
  ...
  return (
    <Layout.Root>
      <Link
        href="https://github.com/dzrootstack/random-visualizer/fork"
        underline="none"
        target="_blank"
        ...
        >
          <Box sx={{ gap: 2 }}>
            <Select
              defaultValue={0}
              onChange={(_, value) =>
                setAlgorithm(Object.keys(Random)[value as number])
              }
            >
          ...
          >
            <Button onClick={randomize} loading={isLoading}>
              Shuffle
            </Button>
          </Badge>
        </Box>
      ...
      <Layout.Main>
        {(result.values.length !== points ||
          ...
          <Alert color="warning" startDecorator={<RxUpdate />}>
